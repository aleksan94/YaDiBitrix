<?
if(!function_exists('get_token_html')) {
			...
			<td colspan="2">
				...
				<div>
					<ol>
						...
						<li>в появившемся поле <b>Callback URI</b> вставляем этот адрес <b><?echo "http://".$_SERVER['SERVER_NAME']."/bitrix/admin/yadi_get_token.php"?></b></li>
